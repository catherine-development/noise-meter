...
def main(meas_root):
    ...
    try:
        ...
        # ── 8. the run modal names the quantity it shows (F7) ─────────────────
        print('\n8. run modal quantities and the 1-second series route')
        ...
        print('\n8b. every modal row is bound to the field its label names')
